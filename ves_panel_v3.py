...
def get_data4VES_panel(vesdf,data_dfs,lith_dict,locations4panel,max_strata_thickness=400):
    ...
    loc_heads=[]
    eles=[]
    # print('locations ',locations4panel)
    # print('vesnos ',vesnos)
    for loc in locations4panel:
        ...
        # print('length of datadfs: ',len(data_dfs))
...
def plot_hibrid_VES_panel(vesdf,data_dfs,lith_dict,locations4panel,dvesdf,drill_dfs,dlith_dict,dlocations4panel,figsize):
    max_strata_thickness=400
    colors=['#C0C0C0','#D3D3D3',	'#00FFFF',	'#FFFF00','#FF0000',	'#00FF00',	'#008000',	'#0000FF','#808000','#800000',		'#008080',		'#000080',	'#FF00FF',	'#800080']
    ...
    if len(dvess)>len(vess):
        ...
        print(dvess,vess)
        intvess=np.append(dvess,[[0]*dvess.shape[1]]*(len(vess)-len(dvess)),axis=0)
        mvess=np.append(vess,intvess,axis=1)
